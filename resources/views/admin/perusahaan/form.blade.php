<form action="{{ isset($companys) ? route('perusahaan.update', $companys->id) : route('perusahaan.store') }}" method="post">
    @csrf
    @if (isset($companys))
        @method('PUT')
    @endif
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control @error('nama_depan') is-invalid @enderror" name="nama_depan" id="nama_depan" type="text"
                    ...
                    value="{{ old('nama_depan', $companys->nama_depan ?? '') }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control @error('email') is-invalid @enderror" name="email"
                    ...
                    value="{{ old('email', $companys->email ?? '') }}">
